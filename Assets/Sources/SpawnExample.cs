...
public class SpawnExample : MonoBehaviour
{
    ...
    private void OnTick()
    {
        ...
        if (chance < 80)
        {
            var nlo1 = new Nlo(_init.Ship, GetRandomPositionOutsideScreen(), Config.NloSpeed);
            var nlo2 = new Nlo(nlo1, GetRandomPositionOutsideScreen(), Config.NloSpeed);

            _factory.CreateNlo(nlo1.SetTarget(nlo2));
